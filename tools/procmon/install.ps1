...
(New-Object System.Net.WebClient).DownloadFile("https://github.com/applied-cyber/ccdc/raw/master/tools/procmon/tcp-udp-all.PMF", "C:\Users\$env:USERNAME\Desktop\ProcessMonitor\tcp-udp-all.PMF"
& "C:\Users\$env:USERNAME\Desktop\ProcessMonitor\Procmon64.exe" /AcceptEula /LoadConfig tcp-udp-all.PMF
